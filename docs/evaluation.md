...
### 3.16 A second blind pass on the same repository — inter-run consistency, measured once
...
- **Inter-run consistency measured once, on one repository — not a general result.** §3.16
